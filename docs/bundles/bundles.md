...
**Installation:**
```bash
npx obsidian-superskills --bundle planning -y
```
...
**Installation:**
```bash
npx obsidian-superskills --bundle research -y
```
...
**Installation:**
```bash
npx obsidian-superskills --bundle obsidian -y
```
...
npx obsidian-superskills install youtube-summarizer -y
...
npx obsidian-superskills install skill-creator

# Install multiple skills
npx obsidian-superskills install skill-creator prompt-engineer youtube-summarizer

# Install with flags
npx obsidian-superskills i skill-creator -a -y -q
```
